...
const Threads = ({ color = [0.39, 0.40, 0.95], amplitude = 1, distance = 0, enableMouseInteraction = true, ...rest }) => {
  ...
  useEffect(() => {
    ...
    try {
      ...
      console.warn("WebGL not supported for Threads background", err);
      return;
    }
    ...
    // Attach listener to window so mouse movement across hero triggers shader wave
